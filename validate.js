function validation(){
    ...
    let sexerr=document.getElementById("sexerr");
    ...
    if(!idcheck.test(id)){iderr.innerText="Invalid Employee ID"; return id=false;}
    if(!namecheck.test(fname)){nameerr.innerText="Invalid Name"; return id=false;}
    if(!mailcheck.test(mail)){mailerr.innerText="Email is required"; return id=false;}
    if(dep===""){deperr.innerText="Department is required"; return id=false;}
    if(date===""){dateerr.innerText="Date is required"; return id=false;}
    if(sex===""){sexerr.innerText="please select one"; return id=false;}
